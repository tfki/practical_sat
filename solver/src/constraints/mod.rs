...
fn seq_counter(lits: &[Lit], solver: &mut Solver<impl SolverImpl>, num_outputs: u32) -> Vec<Lit> {
    ...
    for lit in &lits[1..] {
        ...
        (0..k.min(num_outputs as usize)).for_each(|_| layer_outputs.push(solver.new_lit()));
